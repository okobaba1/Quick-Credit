...
var applyForLoan = [(0, _check.check)('amount').not().isEmpty().withMessage('First name field cannot be empty.'), (0, _check.check)('tenor').not().isEmpty().withMessage('Last name field cannot be empty.'), (0, _check.check)('tenor').isInt().withMessage('Please input your tenor in digits')];
